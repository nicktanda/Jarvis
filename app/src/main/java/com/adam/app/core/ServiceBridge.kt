...
/**
 * Communication hub between AdamService, NotificationCaptureService,
...
object ServiceBridge {
    ...
    const val ACTION_NOTIFICATION = "com.adam.NOTIFICATION"
    const val ACTION_BUTTON_EVENT = "com.adam.BUTTON_EVENT"
    const val ACTION_COMMAND = "com.adam.COMMAND"
