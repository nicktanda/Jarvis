...
class ClaudeIntentParser(private val apiKey: String) {
    ...
    companion object {
        ...
        private const val SYSTEM_PROMPT = """You are a command parser for a voice-controlled phone assistant called Jarvis. The user is speaking commands to control their phone without looking at the screen.
